...
type TambahBahanChildModalProps = {
    ...
    onSubmit: (data: IngredientFormValues) => void | Promise<void>;
}

export default function TambahBahanChildModal({ onClose, initialData, onSubmit }: TambahBahanChildModalProps) {
    const {
        register,
        handleSubmit,
    ...
    const handleFormSubmit = async (data: IngredientFormValues) => {
        try {
            ...
            console.error("Error in Modal handleFormSubmit:", err);
        }
    };
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-primary/20 transition-all font-poppins-400 ${errors.nama ? "border-red" : "border-gray-200"
                            }`}
                    />
                    {errors.nama && (
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            {...register("satuan")}
                            className={`w-full px-4 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-primary/20 transition-all font-poppins-400 bg-white ${errors.satuan ? "border-red" : "border-gray-200"
                                }`}
                        >
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                type="number"
                                placeholder="0"
                                className={`w-full pl-11 pr-4 py-2.5 border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-primary/20 transition-all font-poppins-400 ${errors.harga ? "border-red" : "border-gray-200"
                                    }`}
                            />
                        </div>
                        {errors.harga && (
                ...
                <div className="pt-4 flex gap-3">
                    ...
                    >
                        {isSubmitting ? (initialData ? "Updating..." : "Saving...") : (initialData ? "Update" : "Simpan")}
                    </Button>
                </div>
            </form>
        </div>
