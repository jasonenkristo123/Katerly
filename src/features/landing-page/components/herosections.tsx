    ...
    return (
        <section className="bg-hero-gradient w-full min-h-screen pt-36 pb-20 px-6 md:pt-40 md:px-12 lg:pt-48 lg:px-16 xl:pt-[180px] xl:px-[100px] flex flex-col lg:flex-row items-center gap-12 lg:gap-8 xl:gap-0 overflow-hidden">
            <div className="w-full lg:w-1/2 flex flex-col space-y-6 lg:space-y-8">
                <div className="flex items-center w-max max-w-full gap-3 rounded-[12px] border border-green-bold/30 bg-green-superlight px-3 py-1.5">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-7 w-full sm:w-auto">
                    <Link href="/register" className="w-full sm:w-auto">
                        <Button variant="primary" size="lg" className="w-full sm:w-auto shadow-black/50 shadow-lg justify-center" >
            ...
            <div className="hidden lg:flex w-full lg:w-1/2 items-center justify-center mt-12 lg:mt-0 relative">
                <div className="relative w-full max-w-[400px] xl:max-w-[563px]">
                    ...
                    <div className="flex flex-col bg-white items-start justify-center px-4 sm:px-6 py-2 rounded-2xl w-[140px] xl:w-[162px] h-auto shadow-gray/30 shadow-xl absolute top-[5%] xl:top-[15%] -left-[5%] xl:-left-[5%] z-20">
                    ...
                    <div className="bg-white rounded-2xl shadow-gray/30 shadow-xl absolute flex items-center justify-start px-3 py-3 w-[180px] xl:w-[234px] bottom-[10%] xl:bottom-[20%] -right-[5%] xl:-right-[5%] z-20">
